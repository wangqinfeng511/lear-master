...
-A OUTPUT -p tcp -m tcp --sport 8881 -j ACCEPT
-A INPUT -p tcp -m tcp --dport 8882 -j ACCEPT
-A OUTPUT -p tcp -m tcp --sport 8882 -j ACCEPT
-A INPUT -p tcp -m tcp --dport 8883 -j ACCEPT
-A OUTPUT -p tcp -m tcp --sport 8883 -j ACCEPT
...
-A OUTPUT -p tcp -m tcp --sport 8889 -j ACCEPT
