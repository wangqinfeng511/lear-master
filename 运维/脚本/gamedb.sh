...
-A INPUT -s 192.168.1.0/24 -i eth1 -p tcp -m tcp -j ACCEPT
-A OUTPUT -d 192.168.1.0/24 -o eth1 -p tcp -m tcp -j ACCEPT
-A INPUT -s 192.168.1.0/24 -i eth1 -p icmp -j ACCEPT
-A OUTPUT -d 192.168.1.0/24 -o eth1 -p icmp -j ACCEPT
...
-A INPUT -s 192.168.1.0/24 -i eth1 -p icmp --icmp-type echo-request -j ACCEPT
-A OUTPUT -d 192.168.1.0/24 -o eth1 -p icmp --icmp-type echo-reply -j  ACCEPT
...
-A OUTPUT -d 192.168.1.23 -o eth1 -p tcp -m tcp --dport 21 -j ACCEPT
-A INPUT -s 192.168.1.23 -i eth1 -p tcp -m tcp --sport 21 -j ACCEPT
-A OUTPUT -d 192.168.1.23 -o eth1 -p tcp -m tcp --dport 20 -j ACCEPT
-A INPUT -s 192.168.1.23 -i eth1 -p tcp -m tcp --sport 20 -j ACCEPT
